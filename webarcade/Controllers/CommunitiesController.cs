...
namespace webarcade.Controllers
{
    public class CommunitiesController : Controller
    {
        ...
        {
            return View(await _context.Communitys.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var community = await _context.Communitys
        ...
        public async Task<IActionResult> Create([Bind("Id,game,Criador,Link")] Community community)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,game,Criador,Link")] Community community)
        {
            if (id != community.Id)
            {
                return NotFound();
